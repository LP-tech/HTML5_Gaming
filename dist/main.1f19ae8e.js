...
scene.preload = function () {
  ...
  this.load.image('gold', 'images/tut/gold.png');
};

scene.create = function () {
  //BACKGROUND 
  var bg = this.add.sprite(0, 0, 'background');
  bg.setOrigin(0, 0); //score texte et game texte

  this.scoreText = this.add.text(100, 16, 'score: ' + this.score, {
    fontSize: '32px',
    fill: '#000'
  });
  this.liveText = this.add.text(16, this.sys.game.config.height - 50, 'Lives: ' + this.lives, {
    fontSize: '32px',
    fill: '#000'
  }); //JOUEUR

  this.player = this.add.sprite(150, 150, 'player');
  this.player.setScale(0.3); //ajout de monstre

  this.dragon = this.add.sprite(350, 150, 'dragon');
  this.dragon.setScale; //GOLD

  this.gold = this.add.sprite(50, 150, 'gold');
  this.gold.setScale;
};

scene.update = function () {};

scene.end = function () {}; // var game = new Phaser.Game(640, 360, Phaser.AUTO);
// var GameState = {
//     preload: function(){
//         this.load.image('dragon', 'images/tut/pet_dragon_new.png');
//     },
