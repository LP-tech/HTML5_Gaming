...
gameScene.create = function () {
  ...
  Phaser.Actions.ScaleXY(this.enemies.getChildren(), -0.8, -0.8); //Je definis la vitesse de l'enemie

  Phaser.Actions.Call(this.enemies.getChildren(), function (enemy) {
    enemy.speed = Math.random() * 2 + 1;
  }, this); // this.physics.add.collider(enemies, player);
...
gameScene.gameOver = function () {
  this.isPlayerAlive = false; //ajout shake camera effect

  this.cameras.main.shake(500);
  this.time.delayedCall(500, function () {
    this.scene.restart();
  }, [], this); // var x = (player.x < 400) ? Phaser.Math.Between(400, 800) : Phaser.Math.Between(0, 400);
...
gameScene.gameWin = function () {
  ...
  this.camera.main.shake(500); // this.sprite.on('animationstart', listener);
...
},{}]},{},["../../../../usr/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","game.js"], null)
